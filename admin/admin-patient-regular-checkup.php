            ...
            <fieldset class="bg_form_blue">
                <div class="patient-history-wrap">
                    <div class="d-flex flex-wrap gap-20 justify-content-center ">
                        <div class="d-flex flex-48 flex-m100">
                            <div class="mb-3 d-flex gap-10 w-100 flex-wrap">
                                <div class="w-100 flex-48 flex-m100 flex-mcol">
                        ...
                        <div class="d-flex flex-33 flex-m100">
                            <div class="mb-3 w-100">
