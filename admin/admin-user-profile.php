...
<form action="<?php $uri = explode('/', $_SERVER['REQUEST_URI']);
                        echo '/' . $uri[1] . "/backend/actions/users/update-userprofile.php"; ?>" method="POST" enctype="multipart/form-data">
    <div class="row">
        <div class="col-md-2">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="mb-3">
                            ...
                            <input type="text" name="profile-degree" id="profile-degree" class="form-control form-field border" readonly value="<?php $other_info = json_decode($admin->get_user_otherInfo(), true); echo (!empty($other_info['profile-degree'])) ? $other_info['profile-degree']: ''; ?>">
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="mb-3">
                            <label for="profile-email">Specialization</label>
                            <input type="text" name="profile-specialization" id="profile-specialization" class="form-control form-field border" readonly value="<?php $other_info = json_decode($admin->get_user_otherInfo(), true); echo (!empty($other_info['profile-specialization'])) ? $other_info['profile-specialization'] : '' ; ?>">
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="mb-3">
                            <label for="profile-email">Registration Number</label>
                            <input type="text" name="profile-regno" id="profile-regno" class="form-control form-field border" readonly value="<?php $other_info = json_decode($admin->get_user_otherInfo(), true);  echo (!empty($other_info['profile-regno'])) ? $other_info['profile-regno'] : '' ; ?>">
                        </div>
                    </div>
                    <?php } ?>
                    <div class="col-md-12">
