                    ...
                    <div class="d-flex gap-20  ">
                        <div class="d-flex flex-48 flex-col">
                            ...
                            <div class=" d-flex gap-10 flex-wrap">
                                ...
                                <div class="d-flex flex-30 align-items-center justify-content-center">
                                    <input type="radio" name="patient_gender" id="Gender-Female" class="form-check-input form-field" value="female" <?php echo (!empty($gender) && ($gender === "female")) ? 'checked' : ''; ?>>
                                    <label for="Gender-Female">Female</label>
                                </div>
                                <div class="d-flex flex-30 align-items-center justify-content-center">
                                    <input type="radio" name="patient_gender" id="Gender-Other" class="form-check-input form-field" value="other" <?php echo ((!empty($gender)) && ($gender !== "male" && $gender !== "female")) ? 'checked' : ''; ?>>
