...
<div class="welcome-back">
    <div class="d-flex flex-wrap">
        <div class="flex-15 flex-m100 align-item-center text-center">
        ...
        <div class="flex-80 flex-m100 d-flex justify-content-center flex-column">
            <h2 class="">
    ...
    <div class="row">
        <div class="col-md-3">
            <div class="stats-block ">
                <div class="d-flex w-100 gap-10 flex-mcol flex-tcol">
        ...
        <div class="col-md-3">
            <div class="stats-block">
                <div class="d-flex w-100 gap-10 flex-mcol flex-tcol">
                    ...
                    <div class="d-flex flex-70 flex-mcol flex-tcol">
                        <div>
